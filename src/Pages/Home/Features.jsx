...
function Features() {
    return (
        ...
        >
            ...
            >
                Predefined workflows with several algorithm options for detection of both somatic and germline variants
                in WGS and WES data.
            </FeatureCard>
            <FeatureCard
            ...
            >
                Each variant is classified with more than 15 criteria as defined in ACMG&AMP
                guidelines.
            </FeatureCard>
            <FeatureCard
